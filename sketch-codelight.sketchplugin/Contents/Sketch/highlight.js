...
function run(layer, isDark) {
  if (!(layer instanceof MSTextLayer)) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Please select a Text layer");
    return;
  }
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("It's alive 🙌"); // Select a Text Layer with at least 4 characters
